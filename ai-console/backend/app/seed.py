...
async def seed_algorithms(session: AsyncSession) -> list[int]:
    ...
    algo_data = [
        ("人脸检测", "detection", "安防", "人脸识别与属性分析", [
            ("人脸出现", "检测到人脸出现"),
            ("陌生人告警", "识别到陌生人"),
            ("人脸比对", "人脸比对结果"),
        ]),
        ("车辆识别", "detection", "交通", "车牌识别与车辆属性", [
            ("车辆违停", "检测到车辆违停"),
            ("车辆逆行", "检测到车辆逆行"),
            ("车牌识别", "识别到车牌信息"),
        ]),
        ("行为分析", "analysis", "安防", "异常行为检测", [
            ("异常行为", "检测到异常行为"),
            ("徘徊检测", "人员长时间徘徊"),
            ("物品遗留", "检测到遗留物品"),
        ]),
        ("烟火检测", "detection", "消防", "烟雾与火焰识别", [
            ("烟火告警", "检测到烟火"),
            ("烟雾检测", "检测到烟雾"),
            ("火焰识别", "识别到火焰"),
        ]),
        ("入侵检测", "detection", "安防", "区域入侵告警", [
            ("区域入侵", "人员进入禁区"),
            ("越界检测", "检测到越界行为"),
            ("攀爬检测", "检测到攀爬行为"),
        ]),
        ("人群聚集", "analysis", "安防", "人群密度分析", [
            ("人员聚集", "检测到人群聚集"),
            ("密度超标", "人群密度超过阈值"),
            ("排队检测", "检测到排队现象"),
        ]),
        ("安全帽检测", "detection", "工地", "安全帽佩戴检测", [
            ("安全帽未佩戴", "未佩戴安全帽"),
            ("佩戴不规范", "安全帽佩戴不规范"),
        ]),
        ("反光衣检测", "detection", "工地", "反光衣穿着检测", [
            ("反光衣未穿", "未穿反光衣"),
            ("穿着不规范", "反光衣穿着不规范"),
        ]),
        ("打架检测", "detection", "安防", "肢体冲突识别", [
            ("打架斗殴", "检测到打架行为"),
            ("肢体冲突", "检测到肢体冲突"),
        ]),
        ("摔倒检测", "detection", "养老", "人员摔倒识别", [
            ("人员摔倒", "检测到人员摔倒"),
            ("长时间倒地", "人员长时间倒地未起"),
        ]),
    ]
