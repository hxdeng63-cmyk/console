...
async def start_algorithm_service(service_id: int, db: AsyncSession = Depends(get_db)):
    query = select(AlgorithmService).where(
        AlgorithmService.id == service_id,
        AlgorithmService.deleted_at.is_(None)
    )
...
async def stop_algorithm_service(service_id: int, db: AsyncSession = Depends(get_db)):
    query = select(AlgorithmService).where(
        AlgorithmService.id == service_id,
        AlgorithmService.deleted_at.is_(None)
    )
...
async def restart_algorithm_service(service_id: int, db: AsyncSession = Depends(get_db)):
    query = select(AlgorithmService).where(
        AlgorithmService.id == service_id,
        AlgorithmService.deleted_at.is_(None)
    )
...
async def get_algorithm_service_stats(service_id: int, db: AsyncSession = Depends(get_db)):
    query = select(AlgorithmService).where(
        AlgorithmService.id == service_id,
        AlgorithmService.deleted_at.is_(None)
    )
